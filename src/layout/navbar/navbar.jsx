  ...
  return (
    <>
      <div className=" bg-[#0E1821] py-[22px]">
        ...
        <Link className="text-[#fff] font-medium text-[16px]" to={"/conponent"}>О компании</Link>
        <Link className="text-[#fff] font-medium text-[16px]" to={"/aksiya"}>Акции</Link>
        <Link className="text-[#fff] font-medium text-[16px]" to={"/about"}>Рассрочка 0|0|18</Link>
